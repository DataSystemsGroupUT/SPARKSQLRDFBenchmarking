  ...
  def main(args: Array[String]): Unit = {
   println("ExtVP Partitioned Avro")
    ...
    if (partitionType.toLowerCase == "predicate") {
      ...
      val vpTable27 = spark.read.format("avro").load(s"$path/ST/Avro/SingleStmtTable$partitionType.avro").toDF()
      val vpTable29 = spark.read.format("avro").load(s"$path/VP/Avro/editor$partitionType.avro").toDF()
      val vpTable9 = spark.read.format("avro").load(s"$path/VP/Avro/journal$partitionType.avro").toDF()
      val vpTable11 = spark.read.format("avro").load(s"$path/VP/Avro/name$partitionType.avro").toDF()

      val vpTable1 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/type/issued$partitionType.avro").toDF()
      val vpTable2 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/title/issued$partitionType.avro").toDF()
      val vpTable3 = spark.read.format("avro").load(s"$path/VP/Avro/issued$partitionType.avro").toDF()
      val vpTable4 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/type/pages$partitionType.avro").toDF()
      val vpTable5 = spark.read.format("avro").load(s"$path/VP/Avro/pages$partitionType.avro").toDF()
      val vpTable7 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SO/name/creator$partitionType.avro").toDF()
      val vpTable8 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/creator/journal$partitionType.avro").toDF()
      val vpTable10 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/type/journal$partitionType.avro").toDF()
      val vpTable13 = spark.read.format("avro").load(s"$path/VP/Avro/abstract$partitionType.avro").toDF()
      val vpTable14 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/creator/partOf$partitionType.avro").toDF()
      val vpTable15 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/booktitle/seeAlso$partitionType.avro").toDF()
      val vpTable16 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/partOf/seeAlso$partitionType.avro").toDF()
      val vpTable17 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/homepage/partOf$partitionType.avro").toDF()
      val vpTable18 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/issued/seeAlso$partitionType.avro").toDF()
      val vpTable19 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/type/partOf$partitionType.avro").toDF()
      val vpTable20 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/seeAlso/partOf$partitionType.avro").toDF()
      val vpTable21 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/pages/partOf$partitionType.avro").toDF()
      val vpTable22 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/title/partOf$partitionType.avro").toDF()
      val vpTable23 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/type/creator$partitionType.avro").toDF()
      val vpTable24 = spark.read.format("avro").load(s"$path/VP/Avro/subClassOf$partitionType.avro").toDF()
      val vpTable25 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/issued/creator$partitionType.avro").toDF()
      val vpTable26 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/creator/issued$partitionType.avro").toDF()
      val vpTable28 = spark.read.format("avro").load(s"$path/VP/Avro/seeAlso$partitionType.avro").toDF()
      val vpTable30 = spark.read.format("avro").load(s"$path/ExtVP/Avro/SS/type/name$partitionType.avro").toDF()
