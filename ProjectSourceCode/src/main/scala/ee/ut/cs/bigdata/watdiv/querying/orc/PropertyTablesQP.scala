...
object PropertyTablesQP {
  def main(args: Array[String]): Unit = {
    ...
    if (partitionType == "Predicate") {
      ...
      /*
      FileSystem.get(sc.hadoopConfiguration).listStatus(new Path(s"$path/$partitionType/ORC")).groupBy(file => file.getPath().getName().split("(?=\\p{Upper})")(0)).foreach {

        filestatus =>
          filestatus._2.foreach {
            f =>
              val ptTable = spark.read.format("orc").load(f.getPath().toString)
      ...
      val purchaseProp1 = spark.read.format("orc").load(path + "Predicate/ORC/purchaseDate.orc")
      val purchaseProp2 = spark.read.format("orc").load(path + "Predicate/ORC/purchasePrice.orc")
      val purchaseProp3 = spark.read.format("orc").load(path + "Predicate/ORC/purchasePurchaseFor.orc")
      ...
      val subgenreProp1 = spark.read.format("orc").load(path + "Predicate/ORC/SubgenreGenre.orc")
      val subgenreProp2 = spark.read.format("orc").load(path + "Predicate/ORC/SubgenreTopic.orc")
      ...
      //Retailer
      val retailerProp1 = spark.read.format("orc").load(path + "Predicate/ORC/retailerName.orc")
      val retailerProp2 = spark.read.format("orc").load(path + "Predicate/ORC/retailerLegalName.orc")
      val retailerProp3 = spark.read.format("orc").load(path + "Predicate/ORC/retailerOpeningHours.orc")
      val retailerProp4 = spark.read.format("orc").load(path + "Predicate/ORC/retailerDescription.orc")
      val retailerProp5 = spark.read.format("orc").load(path + "Predicate/ORC/retailerContactPoint.orc")
      val retailerProp6 = spark.read.format("orc").load(path + "Predicate/ORC/retailerTelephone.orc")
      val retailerProp7 = spark.read.format("orc").load(path + "Predicate/ORC/retailerEmail.orc")
      val retailerProp8 = spark.read.format("orc").load(path + "Predicate/ORC/retailerPaymentAccepted.orc")
      val retailerProp9 = spark.read.format("orc").load(path + "Predicate/ORC/retailerFaxNumber.orc")
      val retailerProp10 = spark.read.format("orc").load(path + "Predicate/ORC/retailerAggregateRating.orc")
      ...
      // Offer
      val offerProp1 = spark.read.format("orc").load(path + "Predicate/ORC/offerValidThrough.orc")
      val offerProp2 = spark.read.format("orc").load(path + "Predicate/ORC/offerELigibleQuantity.orc")
      val offerProp3 = spark.read.format("orc").load(path + "Predicate/ORC/offerValidFrom.orc")
      val offerProp4 = spark.read.format("orc").load(path + "Predicate/ORC/offerPrice.orc")
      val offerProp5 = spark.read.format("orc").load(path + "Predicate/ORC/offerSerialNumber.orc")
      val offerProp6 = spark.read.format("orc").load(path + "Predicate/ORC/offerPriceValidUntil.orc")
      ...
      //Review
      val reviewProp1 = spark.read.format("orc").load(path + "Predicate/ORC/reviewReviewer.orc")
      val reviewProp2 = spark.read.format("orc").load(path + "Predicate/ORC/reviewRating.orc")
      val reviewProp3 = spark.read.format("orc").load(path + "Predicate/ORC/reviewText.orc")
      val reviewProp4 = spark.read.format("orc").load(path + "Predicate/ORC/reviewTitle.orc")
      val reviewProp5 = spark.read.format("orc").load(path + "Predicate/ORC/reviewTotalVotes.orc")
      ...
      // Product
      val productProp1 = spark.read.format("orc").load(path + "Predicate/ORC/productProductCategory.orc")
      val productProp2 = spark.read.format("orc").load(path + "Predicate/ORC/productContentRating.orc")
      val productProp3 = spark.read.format("orc").load(path + "Predicate/ORC/productTitle.orc")
      val productProp4 = spark.read.format("orc").load(path + "Predicate/ORC/productText.orc")
      val productProp5 = spark.read.format("orc").load(path + "Predicate/ORC/productDescription.orc")
      val productProp6 = spark.read.format("orc").load(path + "Predicate/ORC/productWordCount.orc")
      val productProp7 = spark.read.format("orc").load(path + "Predicate/ORC/productPrintPage.orc")
      val productProp8 = spark.read.format("orc").load(path + "Predicate/ORC/productPublisher.orc")
      val productProp9 = spark.read.format("orc").load(path + "Predicate/ORC/productPrintSection.orc")
      val productProp10 = spark.read.format("orc").load(path + "Predicate/ORC/productCaption.orc")
      val productProp11 = spark.read.format("orc").load(path + "Predicate/ORC/productComposer.orc")
      val productProp12 = spark.read.format("orc").load(path + "Predicate/ORC/productOpus.orc")
      val productProp13 = spark.read.format("orc").load(path + "Predicate/ORC/productExpires.orc")
      val productProp14 = spark.read.format("orc").load(path + "Predicate/ORC/productMovement.orc")
      val productProp15 = spark.read.format("orc").load(path + "Predicate/ORC/productConductor.orc")
      val productProp16 = spark.read.format("orc").load(path + "Predicate/ORC/productPerformer.orc")
      val productProp17 = spark.read.format("orc").load(path + "Predicate/ORC/productHomepage.orc")
      val productProp18 = spark.read.format("orc").load(path + "Predicate/ORC/productKeywords.orc")
      val productProp19 = spark.read.format("orc").load(path + "Predicate/ORC/productProducer.orc")
      val productProp20 = spark.read.format("orc").load(path + "Predicate/ORC/productDuration.orc")
      val productProp21 = spark.read.format("orc").load(path + "Predicate/ORC/productAward.orc")
      val productProp22 = spark.read.format("orc").load(path + "Predicate/ORC/productPerformed_in.orc")
      val productProp23 = spark.read.format("orc").load(path + "Predicate/ORC/productContentSize.orc")
      val productProp24 = spark.read.format("orc").load(path + "Predicate/ORC/productBookEdition.orc")
      val productProp25 = spark.read.format("orc").load(path + "Predicate/ORC/productIsbn.orc")
      val productProp26 = spark.read.format("orc").load(path + "Predicate/ORC/productRelease.orc")
      val productProp27 = spark.read.format("orc").load(path + "Predicate/ORC/productArtist.orc")
      val productProp28 = spark.read.format("orc").load(path + "Predicate/ORC/productDatePublished.orc")
      val productProp29 = spark.read.format("orc").load(path + "Predicate/ORC/productRecord_number.orc")
      val productProp30 = spark.read.format("orc").load(path + "Predicate/ORC/productPrintEdition.orc")
      val productProp31 = spark.read.format("orc").load(path + "Predicate/ORC/productPrintColumn.orc")
      val productProp32 = spark.read.format("orc").load(path + "Predicate/ORC/productNumberOfPages.orc")
      ...
      //User
      val userProp1 = spark.read.format("orc").load(path + "Predicate/ORC/userUserId.orc")
      val userProp2 = spark.read.format("orc").load(path + "Predicate/ORC/userGivenName.orc")
      val userProp3 = spark.read.format("orc").load(path + "Predicate/ORC/userFamilyName.orc")
      val userProp4 = spark.read.format("orc").load(path + "Predicate/ORC/userEmail.orc")
      val userProp5 = spark.read.format("orc").load(path + "Predicate/ORC/userLocation.orc")
      val userProp6 = spark.read.format("orc").load(path + "Predicate/ORC/userGender.orc")
      val userProp7 = spark.read.format("orc").load(path + "Predicate/ORC/userBirthDate.orc")
      val userProp8 = spark.read.format("orc").load(path + "Predicate/ORC/userAge.orc")
      val userProp9 = spark.read.format("orc").load(path + "Predicate/ORC/userNationality.orc")
      val userProp10 = spark.read.format("orc").load(path + "Predicate/ORC/userTelephone.orc")
      val userProp11 = spark.read.format("orc").load(path + "Predicate/ORC/userHomepage.orc")
      val userProp12 = spark.read.format("orc").load(path + "Predicate/ORC/userJobTitle.orc")
      ...
      //Website
      val WebsitePro1 = spark.read.format("orc").load(path + "Predicate/ORC/websiteLanguage.orc").toDF()
      val WebsitePro2 = spark.read.format("orc").load(path + "Predicate/ORC/websiteHits.orc").toDF()
      val WebsitePro3 = spark.read.format("orc").load(path + "Predicate/ORC/websiteUrl.orc").toDF()
      ...
      val City_DF = spark.read.format("orc").load(path + "Horizontal/ORC/City.orc")
      val Role_DF = spark.read.format("orc").load(path + "Horizontal/ORC/Role.orc")
      val Trailer_DF = spark.read.format("orc").load(path + "Horizontal/ORC/Trailer.orc")
      val Language_DF = spark.read.format("orc").load(path + "Horizontal/ORC/Language.orc")
      val Likes_DF = spark.read.format("orc").load(path + "Horizontal/ORC/Likes.orc")
      val Subscribes_DF = spark.read.format("orc").load(path + "Horizontal/ORC/Subscribes.orc")
      val EligibilityRegion_DF = spark.read.format("orc").load(path + "Horizontal/ORC/EligibilityRegion.orc")
      val HasGenre_DF = spark.read.format("orc").load(path + "Horizontal/ORC/HasGenre.orc")
      val MakesPurchase_DF = spark.read.format("orc").load(path + "Horizontal/ORC/MakesPurchase.orc")
      val Tag_DF = spark.read.format("orc").load(path + "Horizontal/ORC/Tag.orc")
      val Includes_DF = spark.read.format("orc").load(path + "Horizontal/ORC/Includes.orc")
      val Offers_DF = spark.read.format("orc").load(path + "Horizontal/ORC/Offers.orc")
      val HasReview_DF = spark.read.format("orc").load(path + "Horizontal/ORC/HasReview.orc")
      val FriendOf_DF = spark.read.format("orc").load(path + "Horizontal/ORC/FriendOf.orc")
      val Actor_DF = spark.read.format("orc").load(path + "Horizontal/ORC/Actor.orc")
      val PurchaseFor_DF = spark.read.format("orc").load(path + "Horizontal/ORC/PurchaseFor.orc")
      ...
      FileSystem.get(sc.hadoopConfiguration).listStatus(new Path(s"$path/$partitionType/ORC")).foreach {
        x =>
          val ptTable = spark.read.format("orc").load(x.getPath().toString)
