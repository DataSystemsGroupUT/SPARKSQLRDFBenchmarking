...
object PropertyTablesPartition {
  def main(args: Array[String]): Unit = {
    ...
    val Retailer_DF = spark.read.format("orc").load(path + "ORC/Retailer.orc")
    val Website_DF = spark.read.format("orc").load(path + "ORC/Website.orc")
    val Product_DF = spark.read.format("orc").load(path + "ORC/Product.orc")
    val User_DF = spark.read.format("orc").load(path + "ORC/User.orc")
    val Offer_DF = spark.read.format("orc").load(path + "ORC/Offer.orc")
    val City_DF = spark.read.format("orc").load(path + "ORC/City.orc")
    val Review_DF = spark.read.format("orc").load(path + "ORC/Review.orc")
    val Role_DF = spark.read.format("orc").load(path + "ORC/Role.orc")
    val Genre_DF = spark.read.format("orc").load(path + "ORC/Genre.orc")
    val Trailer_DF = spark.read.format("orc").load(path + "ORC/Trailer.orc")
    val Purchase_DF = spark.read.format("orc").load(path + "ORC/Purchase.orc")
    val Language_DF = spark.read.format("orc").load(path + "ORC/Language.orc")
    val Likes_DF = spark.read.format("orc").load(path + "ORC/Likes.orc")
    val Subscribes_DF = spark.read.format("orc").load(path + "ORC/Subscribes.orc")
    val EligibilityRegion_DF = spark.read.format("orc").load(path + "ORC/EligibilityRegion.orc")
    val HasGenre_DF = spark.read.format("orc").load(path + "ORC/HasGenre.orc")
    val MakesPurchase_DF = spark.read.format("orc").load(path + "ORC/MakesPurchase.orc")
    val Tag_DF = spark.read.format("orc").load(path + "ORC/Tag.orc")
    val Includes_DF = spark.read.format("orc").load(path + "ORC/Includes.orc")
    val Offers_DF = spark.read.format("orc").load(path + "ORC/Offers.orc")
    val HasReview_DF = spark.read.format("orc").load(path + "ORC/HasReview.orc")
    val FriendOf_DF = spark.read.format("orc").load(path + "ORC/FriendOf.orc")
    val Actor_DF = spark.read.format("orc").load(path + "ORC/Actor.orc")
    val PurchaseFor_DF = spark.read.format("orc").load(path + "ORC/PurchaseFor.orc")
    ...
    if (partitionType.toLowerCase == "subject") {
      ...
      println("ORC PT partitioned and saved! Subject based Partitioning!")
      ...
      println("ORC PT partitioned and saved! Horizontal partitioning!")
    }
