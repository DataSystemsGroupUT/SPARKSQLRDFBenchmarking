...
object VerticalTablesPartition {
  def main(args: Array[String]): Unit = {
    ...
    if (partitionType == "subject") {
      ...
      vpText.repartition(84, $"Subject").write.option("header", "true").format("avro").mode(SaveMode.Overwrite).save(path + "Subject/Avro/" + "sorg_text.avro")
      ...
      vpdescription.repartition(84, $"Subject").write.option("header", "true").format("avro").mode(SaveMode.Overwrite).save(path + "Subject/Avro/" + "sorg_description.avro")
      ...
      vpText.repartition(84).write.option("header", "true").format("avro").mode(SaveMode.Overwrite).save(path + "Horizontal/Avro/" + "sorg_text.avro")
      ...
      vpdescription.repartition(84).write.option("header", "true").format("avro").mode(SaveMode.Overwrite).save(path + "Horizontal/Avro/" + "sorg_description.avro")
