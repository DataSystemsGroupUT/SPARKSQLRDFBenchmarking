...
object PropertyTablesPartition {
  def main(args: Array[String]): Unit = {
    ...
    val Retailer_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Retailer.csv")
    val Website_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Website.csv")
    val Product_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Product.csv")
    val User_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/User.csv")
    val Offer_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Offer.csv")
    val City_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/City.csv")
    val Review_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Review.csv")
    val Role_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Role.csv")
    val Genre_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Genre.csv")
    val Trailer_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Trailer.csv")
    val Purchase_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Purchase.csv")
    val Language_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Language.csv")
    val Likes_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Likes.csv")
    val Subscribes_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Subscribes.csv")
    val EligibilityRegion_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/EligibilityRegion.csv")
    val HasGenre_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/HasGenre.csv")
    val MakesPurchase_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/MakesPurchase.csv")
    val Tag_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Tag.csv")
    val Includes_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Includes.csv")
    val Offers_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Offers.csv")
    val HasReview_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/HasReview.csv")
    val FriendOf_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/FriendOf.csv")
    val Actor_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/Actor.csv")
    val PurchaseFor_DF = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load(path + "CSV/PurchaseFor.csv")
