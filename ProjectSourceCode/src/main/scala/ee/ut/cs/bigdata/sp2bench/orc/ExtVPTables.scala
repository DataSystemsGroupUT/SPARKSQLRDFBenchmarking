...
object ExtVPTables {
  def main(args: Array[String]): Unit = {
    ...
    val vpTable4 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SS/type/pages$partitionType.orc").toDF()
    val vpTable5 = spark.read.format("orc").load(s"$path/VP/ORC/pages$partitionType.orc").toDF()
    val vpTable7 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SO/name/creator$partitionType.orc").toDF()
    val vpTable8 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SS/creator/journal$partitionType.orc").toDF()
    val vpTable9 = spark.read.format("orc").load(s"$path/VP/ORC/journal$partitionType.orc").toDF()
    val vpTable10 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SS/type/journal$partitionType.orc").toDF()
    val vpTable11 = spark.read.format("orc").load(s"$path/VP/ORC/name$partitionType.orc").toDF()
    val vpTable13 = spark.read.format("orc").load(s"$path/VP/ORC/abstract$partitionType.orc").toDF()
    val vpTable14 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SS/creator/partOf$partitionType.orc").toDF()
    val vpTable15 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SS/booktitle/seeAlso$partitionType.orc").toDF()
    val vpTable16 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SS/partOf/seeAlso$partitionType.orc").toDF()
    val vpTable17 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SS/homepage/partOf$partitionType.orc").toDF()                    
    val vpTable18 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SS/issued/seeAlso$partitionType.orc").toDF()
    val vpTable19 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SS/type/partOf$partitionType.orc").toDF()
    val vpTable20 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SS/seeAlso/partOf$partitionType.orc").toDF()
    val vpTable21 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SS/pages/partOf$partitionType.orc").toDF()
    val vpTable22 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SS/title/partOf$partitionType.orc").toDF()
    val vpTable23 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SS/type/creator$partitionType.orc").toDF()
    val vpTable24 = spark.read.format("orc").load(s"$path/VP/ORC/subClassOf$partitionType.orc").toDF()
    val vpTable25 = spark.read.format("orc").load(s"$path/ExtVP/ORC/SS/issued/creator$partitionType.orc").toDF()
