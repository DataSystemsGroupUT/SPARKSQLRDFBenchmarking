...
object PropertyTablesPartition {
  def main(args: Array[String]): Unit = {
    ...
    val Retailer_DF = spark.read.format("parquet").load(path + "Parquet/Retailer.parquet")
    val Website_DF = spark.read.format("parquet").load(path + "Parquet/Website.parquet")
    val Product_DF = spark.read.format("parquet").load(path + "Parquet/Product.parquet")
    val User_DF = spark.read.format("parquet").load(path + "Parquet/User.parquet")
    val Offer_DF = spark.read.format("parquet").load(path + "Parquet/Offer.parquet")
    val City_DF = spark.read.format("parquet").load(path + "Parquet/City.parquet")
    val Review_DF = spark.read.format("parquet").load(path + "Parquet/Review.parquet")
    val Role_DF = spark.read.format("parquet").load(path + "Parquet/Role.parquet")
    val Genre_DF = spark.read.format("parquet").load(path + "Parquet/Genre.parquet")
    val Trailer_DF = spark.read.format("parquet").load(path + "Parquet/Trailer.parquet")
    val Purchase_DF = spark.read.format("parquet").load(path + "Parquet/Purchase.parquet")
    val Language_DF = spark.read.format("parquet").load(path + "Parquet/Language.parquet")
    val Likes_DF = spark.read.format("parquet").load(path + "Parquet/Likes.parquet")
    val Subscribes_DF = spark.read.format("parquet").load(path + "Parquet/Subscribes.parquet")
    val EligibilityRegion_DF = spark.read.format("parquet").load(path + "Parquet/EligibilityRegion.parquet")
    val HasGenre_DF = spark.read.format("parquet").load(path + "Parquet/HasGenre.parquet")
    val MakesPurchase_DF = spark.read.format("parquet").load(path + "Parquet/MakesPurchase.parquet")
    val Tag_DF = spark.read.format("parquet").load(path + "Parquet/Tag.parquet")
    val Includes_DF = spark.read.format("parquet").load(path + "Parquet/Includes.parquet")
    val Offers_DF = spark.read.format("parquet").load(path + "Parquet/Offers.parquet")
    val HasReview_DF = spark.read.format("parquet").load(path + "Parquet/HasReview.parquet")
    val FriendOf_DF = spark.read.format("parquet").load(path + "Parquet/FriendOf.parquet")
    val Actor_DF = spark.read.format("parquet").load(path + "Parquet/Actor.parquet")
    val PurchaseFor_DF = spark.read.format("parquet").load(path + "Parquet/PurchaseFor.parquet")
