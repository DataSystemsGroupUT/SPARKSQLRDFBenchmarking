...
object VerticalTablesPartition {
  def main(args: Array[String]): Unit = {
    ...
    val vpText = spark.read.format("orc").load(path + "VHDFS/ORC/" + "sorg_text.orc")
    ...
    val vpdescription = spark.read.format("orc").load(path + "VHDFS/ORC/" + "sorg_description.orc")
    ...
    if (partitionType == "subject") {
      ...
      vpText.repartition(84, $"Subject").write.option("header", "true").format("orc").mode(SaveMode.Overwrite).save(path + "Subject/ORC/" + "sorg_text.orc")
      ...
      vpdescription.repartition(84, $"Subject").write.option("header", "true").format("orc").mode(SaveMode.Overwrite).save(path + "Subject/ORC/" + "sorg_description.orc")
      ...
      vpText.repartition(84).write.option("header", "true").format("orc").mode(SaveMode.Overwrite).save(path + "Horizontal/ORC/" + "sorg_text.orc")
      ...
      vpdescription.repartition(84).write.option("header", "true").format("orc").mode(SaveMode.Overwrite).save(path + "Horizontal/ORC/" + "sorg_description.orc")
