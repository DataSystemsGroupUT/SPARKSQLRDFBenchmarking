...
//    VP_Rev_title.createOrReplaceTempView("VP_Rev_title")
    ...
    val queries = List(
      new ExtVPQueries C2, new ExtVPQueries C3,
      ...
      new ExtVPQueries S1, new ExtVPQueries S2, new ExtVPQueries S3,new ExtVPQueries S4, new ExtVPQueries S5,new ExtVPQueries S6, new ExtVPQueries S7, new ExtVPQueries C1
    )
