...
val c2 =
 ...
 ON(tab2.v2=tab1.v2)
 JOIN    (SELECT obj AS v1 , subject AS v0
  FROM VP_legalName
 ...
 ON(tab1.v2=tab3.v2)
 JOIN    (SELECT subject AS v3 , obj AS v8
  FROM OS_hasReview_totalVotes

 ) tab8
 ON(tab3.v3=tab8.v3)
 JOIN    (SELECT obj AS v9 , subject AS v8
  FROM SO_totalVotes_hasReview

 ) tab9
 ON(tab8.v8=tab9.v8)
 JOIN    (SELECT subject AS v7 , obj AS v3
  FROM OS_purchaseFor_hasReview

 ) tab7
 ON(tab8.v3=tab7.v3)
 JOIN    (SELECT obj AS v7 , subject AS v4
 ...
 FROM    (SELECT subject AS v0 , obj AS v3
 ...
 ON(tab2.v0=tab3.v0)
 JOIN    (SELECT subject AS v0 , obj AS v5
  FROM SS_gender_likes

 ) tab4
 ON(tab3.v0=tab4.v0)
 JOIN    (SELECT subject AS v0 , obj AS v6
